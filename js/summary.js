// This is to extend RTE table plugin works in 6.3 and 6.4
(function ($) {
    "use strict";
    ...
    if(CUI.rte.ui.cui.TablePropsDialog.tablerteExtended){
        return;
    }
    ...
    CUI.rte.ui.cui.TablePropsDialog.tablerteExtended = true;
})(jQuery);
